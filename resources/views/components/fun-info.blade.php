            ...
            <table class="h-72 border-collapse border-b border-gray-300">
                <tbody>
                    <tr class="border-b border-gray-300">
                        <td class="px-4 py-2 font-[Montserrat] font-semibold">{{ __('fun.location') }}</td>
                        <td class="px-4 py-2 font-[Montserrat]">{{ $location }}</td>
                    </tr>
                    <tr class="border-b border-gray-300">
                        <td class="px-4 py-2 font-[Montserrat] font-semibold">{{ __('fun.description') }}</td>
                        <td class="px-4 py-2 font-[Montserrat]">{{ $description }}</td>
                    </tr>
                    <tr class="border-b border-gray-300">
                        <td class="px-4 py-2 font-[Montserrat] font-semibold">{{ __('fun.average_price') }}</td>
                        <td class="px-4 py-2 font-[Montserrat]">{{ $averagePrice }}</td>
                    </tr>
                    <tr class="border-b border-gray-300">
                        <td class="px-4 py-2 font-[Montserrat] font-semibold">{{ __('fun.time') }}</td>
