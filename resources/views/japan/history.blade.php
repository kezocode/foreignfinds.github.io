    ...
    <main class="mx-auto max-w-xl">
        ...
        <div class="flex flex-col items-center justify-center space-y-8 sm:flex-row sm:space-x-8 sm:space-y-0">
            <div class="relative mx-4 inline-block">
                <h1
                    class="flex items-center justify-center rounded-lg font-[Montserrat] text-3xl font-semibold text-black">
                    Jomon
                    Period (- 300 BC)</h1>
                <li class="font-[playfair-display] font-[playfair-display] text-xl text-gray-700">
        ...
        <div class="flex flex-col items-center justify-center space-y-8 sm:flex-row sm:space-x-8 sm:space-y-0">
            <div class="relative mx-4 inline-block">
                <h1
                    class="flex items-center justify-center rounded-lg font-[Montserrat] text-3xl font-semibold text-black">
                    Yayoi
                    Period (300 BC - 250 AD)</h1>
                <li class="font-[playfair-display] text-xl text-gray-700">
        ...
        <div class="flex flex-col items-center justify-center space-y-8 sm:flex-row sm:space-x-8 sm:space-y-0">
            <div class="relative mx-4 inline-block">
                <h1
                    class="flex items-center justify-center rounded-lg font-[Montserrat] text-3xl font-semibold text-black">
                    Azuchi-Momoyama Period (1573 - 1603)</h1>
                <li class="font-[playfair-display] text-xl text-gray-700">
