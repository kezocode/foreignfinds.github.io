<x-layout>
    <header class="bg-white shadow-sm">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 class="text-center font-[Oswald] text-3xl font-bold tracking-tight text-gray-900">Where to Visit?</h1>
        </div>
    </header>
        ...
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex flex-col items-center justify-center space-y-8 sm:flex-row sm:space-x-8 sm:space-y-0">
                ...
                <div class="max-w-xl text-center sm:text-left">
                    ...
                    <p class="mb-2 text-xl font-semibold text-gray-800">Top Kyoto Attractions:</p>
                    <ul class="list-disc space-y-2 pl-5 text-gray-700">
                        <li><a class="text-blue-600 hover:text-blue-800"
            ...
            <div class="flex flex-col items-center justify-center space-y-8 sm:flex-row sm:space-x-8 sm:space-y-0">
                ...
                <div class="max-w-xl text-center sm:text-left">
                    ...
                    <p class="mb-2 text-xl font-semibold text-gray-800">Top Tokyo Attractions:</p>
                    <ul class="list-disc space-y-2 pl-5 text-gray-700">
                        <li><a class="text-blue-600 hover:text-blue-800"
            ...
            <div class="flex flex-col items-center justify-center space-y-8 sm:flex-row sm:space-x-8 sm:space-y-0">
                ...
                <div class="max-w-xl text-center sm:text-left">
                    ...
                    <p class="mb-2 text-xl font-semibold text-gray-800">Top Osaka Attractions:</p>
                    <ul class="list-disc space-y-2 pl-5 text-gray-700">
                        <li><a class="text-blue-600 hover:text-blue-800"
            ...
            <div class="flex flex-col items-center justify-center space-y-8 sm:flex-row sm:space-x-8 sm:space-y-0">
                ...
                <div class="max-w-xl text-center sm:text-left">
                    ...
                    <p class="mb-2 text-xl font-semibold text-gray-800">Top Kanazawa Attractions:</p>
                    <ul class="list-disc space-y-2 pl-5 text-gray-700">
                        <li><a class="text-blue-600 hover:text-blue-800"
